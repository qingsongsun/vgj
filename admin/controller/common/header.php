...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		// huwen added 
		$data['text_report_complete_status'] = $this->language->get('text_report_complete_status');
...
// huwen added
			...
			$data['report_complete_status_total'] = $this->model_report_product->getTotalPurchased(array('filter_order_status_id'=> implode(',', $this->config->get('config_complete_status'))));
			$data['report_complete_status'] = $this->url->link('report/product_complete', 'token=' . $this->session->data['token'] . '&filter_order_status_id=' . implode(',', $this->config->get('config_complete_status')), 'SSL');
