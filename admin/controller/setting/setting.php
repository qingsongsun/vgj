...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_shipping_cost'])) {
			$data['config_shipping_cost'] = $this->request->post['config_shipping_cost'];
		} else {
			$data['config_shipping_cost'] = $this->config->get('config_shipping_cost');
		}
