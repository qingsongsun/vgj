...
class ControllerUserUserPermission extends Controller {
	...
	protected function getForm() {
		...
		// huwen added
		$data['entry_diy']=$this->language->get('entry_diy');
		...
		$data['page_inputs']=array('product_model','product_name','product_stock_status' ,'product_shipping' , 'product_keyword', 'product_date', 'product_length_class', 'product_length', 'product_weight', 'product_weight_class',  'product_sort_order',  'product_status',  'product_description_diy',  'product_meta','meta_description', 'meta_keyword',  'meta_title',  'product_image',  'product_location',  'product_price',  'product_label',  'product_quantity','product_minimum',  'product_subtract','product_option_diy','product_attribute','product_recurring_diy','product_discount_diy','product_special_diy','product_image_diy','product_reward_diy','product_design_diy','product_repo_diy','manufacturer_diy','category_diy','product_filter_diy','product_store_diy','product_download_diy','product_related_diy');

		// huwen added for page DIY
		if (isset($this->request->post['permission']['diy'])) {
			$data['diy'] = $this->request->post['permission']['diy'];
		} elseif (isset($user_group_info['permission']['diy'])) {
			$data['diy'] = $user_group_info['permission']['diy'];
		} else {
			$data['diy'] = array();
		}
