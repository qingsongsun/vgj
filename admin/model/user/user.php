...
class ModelUserUser extends Model {
	...
	// huwen added for bind openid
	public function bindOpenid($openid,$user_id){
		$this->db->query("UPDATE ".DB_PREFIX."user SET openid='".$openid."' WHERE user_id='".$user_id."'");
	}
...
$this->log->write('kankan');
$this->log->write($openid);
		$query=$this->db->query("SELECT user_id FROM ".DB_PREFIX."user WHERE openid='".$openid."'");
$this->log->write($query);
	...
	public function unbindOpenid($user_id){
		$this->db->query("UPDATE ".DB_PREFIX."user SET openid='' WHERE user_id='".$user_id."'");
	}
}