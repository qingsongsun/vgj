            ...
            <ul>
                ...
                <li>
                    <span class="module-create-title">Agree to Privacy Policy</span>
                            <span class="module-create-option">
                                This is edited from <strong>Opencart > System > Settigns > Option > Account > Account Terms</strong>.
                            </span>
                    <a href="#" target="_blank" class="journal-tip"> </a>
                </li>
                <li>
                    <span class="module-create-title">Agree to Terms</span>
                            <span class="module-create-option">
                                This is edited from <strong>Opencart > System > Settigns > Option > Checkout > Checkout Terms</strong>.
                            </span>
                    <a href="#" target="_blank" class="journal-tip"> </a>
                </li>
