...
<div id="content">
  <div class="page-header">
    ...
    <div class="container-fluid">
              ...
              <div class="tab-pane active" id="tab-general">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                    ...
                    <!-- 商品名称 -->
                    <div  <?php echo $product_name==true?'':'style="display: none;"' ?> class="form-group required">
                    ...
                    <!-- model -->
                    <div  <?php echo $product_model==true?'':'style="display: none;"' ?> class="form-group required">
                      <label class="col-sm-2 control-label" for="input-model"><?php echo $entry_model; ?></label>
                      <div class="col-sm-10">
                        <input type="text" name="model" value="<?php echo $model; ?>" placeholder="<?php echo $entry_model_barcode; ?>" id="input-model" class="form-control" />
                        <?php if ($error_model) { ?>
                        <div class="text-danger"><?php echo $error_model; ?></div>
                        <?php } ?>
                      </div>
                    </div>
                    <!-- huwen added for ticket_print -->
                    <div class="qrcode_ticket_print">
                      <fieldset>
                       <legend class="qrcode_ticket_print_print"><?php echo '合格证信息'; ?></legend>
                       <!-- 品名 -->
                       <div  <?php echo $product_model==true?'':'style="display: none;"' ?> class="form-group">
                         <label class="col-sm-2 control-label" for="input-model"><?php echo '品名'; ?></label>
                         <div class="col-sm-10">
                          <input type="text" name="ticket_partName" value="<?php echo $ticket_partName; ?>" placeholder="<?php echo '品名'; ?>" id="input-ticket_partName" class="form-control" />
                          <?php if ($error_partName) { ?>
                          <div class="text-danger"><?php echo $error_partName; ?></div>
                          <?php } ?>
                        </div>
                      </div>
                      <!-- 款号 -->
                      <div  <?php echo $product_model==true?'':'style="display: none;"' ?> class="form-group">
                       <label class="col-sm-2 control-label" for="input-model"><?php echo '款号'; ?></label>
                       <div class="col-sm-10">
                        <input type="text" name="ticket_styleCode" value="<?php echo $ticket_styleCode; ?>" placeholder="<?php echo '款号'; ?>" id="input-ticket_styleCode" class="form-control" />
                        <?php if ($error_ticket_styleCode) { ?>
                        <div class="text-danger"><?php echo $error_ticket_styleCode; ?></div>
                        <?php } ?>
                      </div>
                    </div>
                    <!-- 尺码 -->
                    <div  <?php echo $product_model==true?'':'style="display: none;"' ?> class="form-group">
                     <label class="col-sm-2 control-label" for="input-model"><?php echo '尺码'; ?></label>
                     <div class="col-sm-10">
                      <input type="text" name="ticket_size" value="<?php echo $ticket_size; ?>" placeholder="<?php echo '尺码'; ?>" id="input-ticket_size" class="form-control" />
                      <?php if ($error_ticket_size) { ?>
                      <div class="text-danger"><?php echo $error_ticket_size; ?></div>
                      <?php } ?>
                    </div>
                  </div>
                  <!-- 颜色 -->
                  <div  <?php echo $product_model==true?'':'style="display: none;"' ?> class="form-group">
                   <label class="col-sm-2 control-label" for="input-model"><?php echo '颜色'; ?></label>
                   <div class="col-sm-10">
                    <input type="text" name="ticket_color" value="<?php echo $ticket_color; ?>" placeholder="<?php echo '颜色'; ?>" id="input-ticket_color" class="form-control" />
                    <?php if ($error_ticket_color) { ?>
                    <div class="text-danger"><?php echo $error_ticket_color; ?></div>
                    <?php } ?>
                  </div>
                </div>
                <!-- 面料 -->
                <div  <?php echo $product_model==true?'':'style="display: none;"' ?> class="form-group">
                 <label class="col-sm-2 control-label" for="input-model"><?php echo '面料'; ?></label>
                 <div class="col-sm-10">
                  <input type="text" name="ticket_fabric" value="<?php echo $ticket_fabric; ?>" placeholder="<?php echo '面料'; ?>" id="input-ticket_fabric" class="form-control" />
                  <?php if ($error_ticket_fabricartName) { ?>
                  <div class="text-danger"><?php echo $error_ticket_fabric; ?></div>
                  <?php } ?>
                </div>
              </div>
              <!-- 等级 -->
              <div  <?php echo $product_model==true?'':'style="display: none;"' ?> class="form-group">
               <label class="col-sm-2 control-label" for="input-model"><?php echo '等级'; ?></label>
               <div class="col-sm-10">
                <input type="text" name="ticket_rank" value="<?php echo $ticket_rank; ?>" placeholder="<?php echo '等级'; ?>" id="input-ticket_rank" class="form-control" />
                <?php if ($error_ticket_rank) { ?>
                <div class="text-danger"><?php echo $error_ticket_rank; ?></div>
                <?php } ?>
              </div>
            </div>
            <!-- 地址 -->
            <div  <?php echo $product_model==true?'':'style="display: none;"' ?> class="form-group">
             <label class="col-sm-2 control-label" for="input-model"><?php echo '地址'; ?></label>
             <div class="col-sm-10">
              <input type="text" name="ticket_address" value="<?php echo $ticket_address; ?>" placeholder="<?php echo '地址'; ?>" id="input-ticket_address" class="form-control" />
              <?php if ($error_ticket_address) { ?>
              <div class="text-danger"><?php echo $error_ticket_address; ?></div>
              <?php } ?>
            </div>
          </div>
          <legend></legend>
      ...
      <div <?php echo $product_price==true?'':'style="display: none;"' ?> class="form-group">
      ...
      <!-- cost_price -->
      <div <?php echo $product_price==true?'':'style="display: none;"' ?> class="form-group">
        <label class="col-sm-2 control-label" for="input-cost_price"><?php echo '成本价格'; ?></label>
        <div class="col-sm-10">
          <input  type="text" name="cost_price" value="<?php echo $cost_price; ?>" placeholder="<?php echo '成本价格'; ?>" id="input-cost_price" class="form-control" />
        </div>
      </div>
      ...
      <div  <?php echo $product_meta==true?'':'style="display: none;"' ?> class="form-group ">
      ...
      <!-- meta描述 -->
      <div  <?php echo $meta_description==true?'':'style="display: none;"' ?> class="form-group">
      ...
      <!-- meta关键字 -->
      <div <?php echo $meta_keyword==true?'':'style="display: none;"' ?> class="form-group">
      ...
      <!-- 商品标签 -->
      <div  <?php echo $meta_title==true?'':'style="display: none;"' ?> class="form-group">
      ...
      <div class="tab-pane" id="tab-data">
        <!-- 图片 -->
        <div  <?php echo $product_image==true?'':'style="display: none;"' ?> class="form-group">
        ...
        <?php if ($issetQrcode): ?>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-qrcode"><?php echo '二维码'; ?></label>
            <div class="col-sm-10">
             <div id="msg"></div>
             <img src="view/image/qrcode/<?php echo urlencode($product_model); ?>.png" alt="" title="" " />
           </div>
         </div>
       <?php endif ?>

       <!-- location -->
       <div <?php echo $product_location==true?'':'style="display: none;"' ?> class="form-group">
      ...
      <!-- label -->
      <div  <?php echo $product_label==true?'':'style="display: none;"' ?> class="form-group">
      ...
      <!-- 数量 -->
      <div  <?php echo $product_quantity==true?'':'style="display: none;"' ?> class="form-group">
        <label class="col-sm-2 control-label" for="input-quantity"><?php echo $entry_quantity; ?></label>
        <div class="col-sm-10">
          <input type="text" disabled="disabled" name="quantity" value="<?php echo $quantity; ?>" placeholder="<?php echo $entry_quantity; ?>" id="input-quantity" class="form-control" />
        </div>
      </div>


      <!-- 最小起订 -->
      <div  <?php echo $product_minimum==true?'':'style="display: none;"' ?> class="form-group">
      ...
      <!-- 是否减仓库 -->
      <div <?php echo $product_subtract==true?'':'style="display: none;"' ?>  class="form-group">
      ...
      <!-- 库存状况 -->
      <div  <?php echo $product_stock_status==true?'':'style="display: none;"' ?> class="form-group">
      ...
      <!-- 是否配送 -->
      <div  <?php echo $product_shipping==true?'':'style="display: none;"' ?> class="form-group">
      ...
      <!-- seo keyword -->
      <div  <?php echo $product_keyword==true?'':'style="display: none;"' ?> class="form-group">
      ...
      <!-- 供货日期 -->
      <div <?php echo $product_date==true?'':'style="display: none;"' ?>  class="form-group">
        ...
        <!-- 尺寸 -->
        <div  <?php echo $product_length==true?'':'style="display: none;"' ?> class="form-group">
        ...
        <!-- 长度单位 -->
        <div  <?php echo $product_length_class==true?'':'style="display: none;"' ?> class="form-group">
        ...
        <!-- 重量 -->
        <div  <?php echo $product_weight==true?'':'style="display: none;"' ?> class="form-group">
        ...
        <!-- 重量单位 -->
        <div <?php echo $product_weight_class==true?'':'style="display: none;"' ?>  class="form-group">
        ...
        <!-- 状态 -->
        <div  <?php echo $product_status==true?'':'style="display: none;"' ?> class="form-group">
        ...
        <!-- 排序 -->
        <div <?php echo $product_sort_order==true?'':'style="display: none;"' ?>  class="form-group">
        ...
        <!-- 商品描述 -->
        <div <?php echo $product_description_diy==true?'':'style="display: none;"' ?>  class="form-group">
  ...
  <div class="tab-pane" id="tab-links">
    <div <?php echo $manufacturer_diy==true?'':'style="display: none;"' ?> class="form-group">
    ...
    <div <?php echo $category_diy==true?'':'style="display: none;"' ?> class="form-group">
    ...
    <div  <?php echo $product_filter_diy==true?'':'style="display: none;"' ?> class="form-group">
    ...
    <div <?php echo $product_store_diy==true?'':'style="display: none;"' ?>  class="form-group">
    ...
    <div <?php echo $product_download_diy==true?'':'style="display: none;"' ?>  class="form-group">
    ...
    <div <?php echo $product_related_diy==true?'':'style="display: none;"' ?>  class="form-group">
  ...
  <!-- 选项 -->
  <div  <?php echo $product_option_diy==true?'':'style="display: none;"' ?> class="tab-pane" id="tab-option">
    <legend class="qrcode_ticket_print_print"><?php echo '选项'; ?></legend>
    <div class="row">
      <div class="col-sm-2">
      ...
      <div class="col-sm-10">
                    ...
                    <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                      <thead>
                        <tr>
                          ...
                          <td class="text-left"><?php echo $entry_barcode; ?></td>
                      ...
                      <tbody>
                        ...
                        <tr id="option-value-row<?php echo $option_value_row; ?>">
                          ...
                          <!-- huwen added -->
                          <td class="text-left" ><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][barcode]" value="<?php echo $product_option_value['barcode']; ?>" placeholder="<?php echo $entry_barcode; ?>" class="form-control" /></td>
                          <!-- huwen -->

                          <td class="text-left" width="<?php echo max(strlen($product_option_value['quantity'])*15,100); ?>"><input type="text" readonly="readonly" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][quantity]" value="<?php echo $product_option_value['quantity']; ?>" placeholder="<?php echo $entry_quantity; ?>" class="form-control" /></td>
                          <td class="text-left" width="80"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][subtract]" class="form-control">
                          ...
                          <td class="text-right" width="<?php echo max(strlen($product_option_value['price'])*15,100); ?>"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price_prefix]" class="form-control">
                          ...
                          <td class="text-right" width="<?php echo max(strlen($product_option_value['points'])*15,100); ?>"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][points_prefix]" class="form-control">
                          ...
                          <td class="text-right" width=<?php echo max(strlen($product_option_value['weight'])*15,100); ?>><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][weight_prefix]" class="form-control">
        ...
        <!-- 库存 -->
        <!-- Luke added begin -->
        <div <?php echo $product_repo_diy==true?'':'style="display: none;"' ?>  class="row">
            ...
            <div class="table-responsive">
              <table class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    <td class="text-left"><?php echo $entry_option_value; ?></td>
                    <?php foreach ($repo_names as $name) { ?>
                ...
                <tbody>
                  ...
                  <tr>
                    <td></td>
                    <?php foreach ($repo_names as $name) { ?>
                    <?php if (isset($product_amount[$name])) { ?>
                    <td class="text-left"><?php echo $product_amount[$name]; ?></td>
                    <?php } else { ?>
                  ...
                  <tr>
                    ...
                    <?php foreach ($repo_names as $name) { ?>
                    <?php if (isset($product_option_value['amt_in_repos'][$name])) { ?>
                    <td class="text-left"><?php echo $product_option_value['amt_in_repos'][$name]; ?></td>
                    <?php } else { ?>
                    <td class="text-left">0</td>
                    <?php } ?>
                    <?php } ?>
        ...
        <!-- 属性 -->
        <div  <?php echo $product_attribute==true?'':'style="display: none;"' ?> class="tab-pane" id="tab-attribute">
          <legend class="qrcode_ticket_print_print"><?php echo '属性'; ?></legend>
          <div class="table-responsive">
            ...
            <div  <?php echo $product_recurring_diy==true?'':'style="display: none;"' ?> class="tab-pane" id="tab-recurring">
              <legend class="qrcode_ticket_print_print"><?php echo ''; ?></legend>
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
            ...
            <div  <?php echo $product_discount_diy==true?'':'style="display: none;"' ?> class="tab-pane" id="tab-discount">
              <legend class="qrcode_ticket_print_print"><?php echo '促销'; ?></legend>
              <div class="table-responsive">
                ...
                <!-- 优惠 -->
                <div <?php echo $product_special_diy==true?'':'style="display: none;"' ?>  class="tab-pane" id="tab-special">
                  <legend class="qrcode_ticket_print_print"><?php echo '优惠'; ?></legend>
                  <div class="table-responsive">
                    ...
                    <!-- 图片 -->
                    <div  <?php echo $product_image_diy==true?'':'style="display: none;"' ?> class="tab-pane" id="tab-image">
                      <legend class="qrcode_ticket_print_print"><?php echo '图片'; ?></legend>
                      <div class="table-responsive">
                    ...
                    <!-- 积分 -->
                    <div  <?php echo $product_reward_diy==true?'':'style="display: none;"' ?> class="tab-pane" id="tab-reward">
                      <legend class="qrcode_ticket_print_print"><?php echo '积分'; ?></legend>
                      <div class="form-group">
                    ...
                    <!-- 设计 -->
                    <div  <?php echo $product_design_diy==true?'':'style="display: none;"' ?> class="tab-pane" id="tab-design">
                      <legend class="qrcode_ticket_print_print"><?php echo '设计'; ?></legend>
                      <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                          <thead>
                            <tr>
  ...
  'select': function(item) {
   ...
   if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
     ...
     html += '        <td class="text-left"><?php echo $entry_option_value; ?></td>';
      // huwen added
      html += '        <td class="text-right"><?php echo $entry_barcode; ?></td>';
...
<script type="text/javascript"><!--
  ...
  // huwen added
  html += '  <td class="text-right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][barcode]" value="" placeholder="<?php echo $entry_barcode; ?>" class="form-control" /></td>';
  html += '  <td class="text-right"><input type="text" readonly="readonly" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][quantity]" value="" placeholder="<?php echo $entry_quantity; ?>" class="form-control" /></td>';
