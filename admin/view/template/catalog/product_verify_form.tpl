              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                	...
                	<!-- <div  class="form-group required">
	                    <label class="col-sm-2 control-label" for="input-num"><?php echo '生成验证码的数量'; ?></label>
	                    <div class="col-sm-10">
	                      <input type="text" name="num" value="<?php echo $num; ?>" placeholder="<?php echo '请输入要生成的防伪验证吗的数量'; ?>" id="input-num" class="form-control" />
	                      <?php if ($error_num) { ?>
	                      <div class="text-danger"><?php echo $error_num; ?></div>
	                      <?php } ?>
	                    </div>
                  	</div> -->
...
<!--
                  <div  <?php echo $product_model==true?'':'style="display: none;"' ?> class="form-group required">
                    <label class="col-sm-2 control-label" for="input-model"><?php echo '序列号(SN)'; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="model" value="<?php echo $model; ?>" placeholder="<?php echo $entry_model_barcode; ?>" id="input-model" class="form-control" />
                      <?php if ($error_model) { ?>
                      <div class="text-danger"><?php echo $error_model; ?></div>
                  ...
                  <div  <?php echo $product_model==true?'':'style="display: none;"' ?> class="form-group required">
                    <label class="col-sm-2 control-label" for="input-model"><?php echo '产生二维码的数量'; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="model" value="<?php echo $model; ?>" placeholder="<?php echo $entry_model_barcode; ?>" id="input-model" class="form-control" />
                      <?php if ($error_model) { ?>
                      <div class="text-danger"><?php echo $error_model; ?></div>
                ...
                <!--   <div  <?php echo $product_model==true?'':'style="display: none;"' ?> class="form-group">
                    <label class="col-sm-2 control-label" for="input-ScanCounter"><?php echo '被扫描次数'; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="ScanCounter" value="<?php echo $ScanCounter; ?>" placeholder="<?php echo ''; ?>" id="input-ScanCounter" class="form-control" />
                      <?php if ($error_ScanCounter) { ?>
                      <div class="text-danger"><?php echo $error_model; ?></div>
                      <?php } ?>
                    </div>
                  </div>
...
<!--
                  <div  <?php echo $product_model==true?'':'style="display: none;"' ?> class="form-group required">
                    <label class="col-sm-2 control-label" for="input-model"><?php echo 'CODE'; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="model" value="<?php echo $model; ?>" placeholder="<?php echo $entry_model_barcode; ?>" id="input-model" class="form-control" />
                      <?php if ($error_model) { ?>
                      <div class="text-danger"><?php echo $error_model; ?></div>
                  ...
                  <div class="tab-pane" id="tab-data">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-qrcode"><?php echo '防伪验证吗'; ?></label>
                      <div class="col-sm-10">
                       <div id="msg"></div>
                           <img src="view/image/uniqueQrcode/<?php echo $model."_".$sn; ?>.png" alt="" title="" " />
                      </div>
                    </div>
                    <?php// endif ?>
                  </div>
