...
<!-- huwen added for report -->
        <li class="divider"></li>

        <li><a href="<?php echo $report_complete_status; ?>"><span class="label label-success pull-right"><?php echo $report_complete_status_total; ?></span><?php echo $text_report_complete_status; ?></a></li>
        <!-- end -->
