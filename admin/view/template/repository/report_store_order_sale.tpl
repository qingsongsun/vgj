            ...
            <table class="table table-bordered table-hover" id="report_store_sale">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'status') { ?>
                    ...
                    <!-- huwen added -->
                    <td class="text-right"><?php if ($sort == 'o.subtotal') { ?>
                    <a href="<?php echo $sort_subtotal; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_subtotal; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_subtotal; ?>"><?php echo $column_subtotal; ?></a>
                    <?php } ?></td>
                    <!-- end -->
                  ...
                  <td class="text-left"><?php if ($sort == 'o.date_modified') { ?>
                    ...
                    <?php } ?></td>
                    <td class="text-right"><?php echo '店铺名'; ?></td>
                  <td class="text-right"><?php echo '订单附言'; ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $order['repo_name']; ?></td>
                  <!-- comments -->
                  <td class="text-left"><?php echo $order['order_comment']; ?></td>
                </tr>
...
$('input[name^=\'selected\']').on('change', function() {
  //Huwen modified the prop()
  $('#button-shipping, #button-invoice').prop('disabled', false);
