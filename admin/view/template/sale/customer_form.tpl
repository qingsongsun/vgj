        ...
        <div class="panel-body">
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer" class="form-horizontal">
            <ul class="nav nav-tabs">
              ...
              <?php if ($user_group == GROUP_NAME_VIP_USER) { // Wenliang added, only for VIP customer, the transacation tab is showed ?>
...
<?php /*  Wenliang Removed, for Chinese naming style
...
*/ ?>
<?php /*  Wenliang Removed, hiding info
                      <div class="form-group required">
...
*/ ?>
<div class="form-group required" name="telephone">
        ...
        <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order']; ?>">
          ...
          <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order']; ?>">
            ...
            <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order']; ?>">
              ...
              <!-- for username -->
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-email"><?php echo '用户标志'; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="email" value="<?php echo $email; ?>" placeholder="<?php echo '用户标志（登录用户名）'; ?>" id="input-email" class="form-control" autocomplete="on" />
                  <?php if ($error_email) { ?>
                  <div class="text-danger"><?php echo $error_email; ?></div>
                  <?php  } ?>
                </div>
...
<?php /* Wenliang removed, newsletter not needed/supported
                      <div class="form-group">
...
<?php /* Wenliang removed, for simplified info
                      <div class="form-group">
...
<div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 1; ?>">
  ...
  <div class="col-sm-10">
    ...
    <div class="tab-pane" id="tab-transaction">
      ...
      <?php // Wenliang added, for adjusting the authorized credit and transaction together ?> <p/><br/>
      <div class="text-right">
        <button type="button" id="button-credit" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_credit_adjust; ?></button>
      </div>
    </div>
...
<script type="text/javascript"><!--
  $('select[name=\'customer_group_id\']').on('change', function() {
   ...
   if ($('select[name=\'customer_group_id\']').find("option:selected").text() == '<?php echo GROUP_NAME_VIP_USER; ?>') {
    $('div[name=\'telephone\']').show();
  } else {
    $('div[name=\'telephone\']').hide();
  }
...
// Wenliang added, for adjusting the authorized credit and transaction together
