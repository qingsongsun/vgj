        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
              <legend><?php echo '运费'; ?></legend>
              <!-- huwen added for shipping_cost -->
              <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-shipping_cost"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo '请输入app下单快递所需的运费'; ?>"><?php echo '运费：'; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_shipping_cost" value="<?php echo $config_shipping_cost; ?>" placeholder="<?php echo '运费'; ?>" id="input-shipping_cost" class="form-control" />
                </div>
              </div>
