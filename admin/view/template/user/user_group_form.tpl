    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-user-group" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $entry_diy; ?></label>
            <div class="col-sm-10">
              <div class="well well-sm" style="height: 150px; overflow: auto;">
                <?php foreach ($page_inputs as $page_input) { ?>                
                <div class="checkbox">
                  <label>
                    <?php if (in_array($page_input, $diy)) { ?>
                    <input type="checkbox" name="permission[diy][]" value="<?php echo $page_input; ?>" checked="checked" />
                    <?php echo $page_input; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="permission[diy][]" value="<?php echo $page_input; ?>" />
                    <?php echo $page_input; ?>                    
                    <?php } ?>
                  </label>
                </div>
