	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if ($order_status_id != '2') {
				$this->model_checkout_order->addOrderHistory($this->request->post['order_id'], "1", "客户提交了退换货申请");
			}
...
// Wenliang modified, not showing the internal fake email
