...
class ControllerAccountTransaction extends Controller {
	...
	public function index() {
		...
		// Wenliang added, for showing the total credit and debt
		$this->load->model('account/customer');
		$query = $this->model_account_customer->getVipInfoByCustomerId($this->customer->getId());
		$data['total_credit'] = $this->currency->format($query->row['credit_amount']);
		$data['total_debt'] = $this->currency->format($query->row['credit_amount'] - $this->customer->getBalance());
		$data['text_total_credit'] = $this->language->get('text_total_credit');
		$data['text_total_debt'] = $this->language->get('text_total_debt');
