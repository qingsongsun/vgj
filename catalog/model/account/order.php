...
class ModelAccountOrder extends Model {
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'shipping_name_value' => $order_query->row['shipping_name_value'],
	...
	// huwen added
	public function getOrderShippingcode($order_id) {
		$query = $this->db->query("SELECT shipping_code FROM ".DB_PREFIX."order WHERE order_id='".(int) $order_id."'");
		return $query->row;
	}
