...
class ModelAppCheckout extends Model {
...
/*     This is for debug purpose, shall be deleted before commercial relesae
...
*/
    ...
    public function save() {
    	...
    	if (isset($this->session->data['json_data'])) {
    		$json_data=$this->session->data['json_data'];
...
$total=$json_data['total'];
       ...
       foreach ($json_data['cart_info'] as $product) {
    ...
    public function getTotal() {
        ...
        $total=$this->session->data['json_data']['total'];
