...
// 绘制背景
Sketchpad.prototype.drawBackground=function(imgPath){
  var img=new Image();
  img.src=imgPath;
  img.onload=function(){
    this.canvas.drawImage(img,0,0,this.canvas.width,this.canvas.height);
  }
}
