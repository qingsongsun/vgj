...
<?php /* Wenliang removed, hiding email address since we rely on phone field; and use Chinese naming conversion           
          <div class="form-group required">
...
*/ ?>
        ...
        <div class="buttons">
          ...
          <!-- Huwen modified the value-->
            <input type="submit" value="保存修改" class="btn btn-primary button" />
          </div>
        </div>
      </form>
      </div>
