...
*/ ?>
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-phone_or_card"><?php echo $entry_phone_or_card; ?></label>
            <div class="col-sm-10">
              <input type="tel" name="phone_or_card" value="<?php echo $phone_or_card; ?>" placeholder="<?php echo $entry_phone_or_card; ?>" id="input-phone_or_card" class="form-control" />
              <?php if ($error_phone_or_card) { ?>
              <div class="text-danger"><?php echo $error_phone_or_card; ?></div>
              <?php } ?>
            </div>
            <div class="text-danger" id="error-phone" style="display: none;"><?php echo $error_phone; ?></div>
            <div class="text-danger" id="error-card" style="display: none;"><?php //echo $error_card; ?></div>
          </div>
<?php /* Wenliang removed
...
checkPhoneOrCard();
$('input[name=\'phone_or_card\']').on('blur', checkPhoneOrCard);
