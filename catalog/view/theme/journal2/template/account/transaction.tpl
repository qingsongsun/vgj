...
<div id="container" class="container j-container">
  ...
  <div class="row"><?php echo $column_left; ?><?php echo $column_right; ?>
    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <?php // Wenliang added, for show the total credit and debt ?> 
      <p><?php echo $text_total_credit; ?> <b><?php echo $total_credit; ?></b>.</p><br/>
      <p><?php echo $text_total_debt; ?> <b><?php echo $total_debt; ?></b>.</p><br/>
