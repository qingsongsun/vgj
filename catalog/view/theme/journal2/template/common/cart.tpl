<div id="cart" class="btn-group btn-block">
  <button type="button" data-toggle="dropdown" class="btn btn-inverse btn-block btn-lg dropdown-toggle heading"><a><span id="cart-total" data-loading-text="<?php echo $text_loading; ?>&nbsp;&nbsp;"><?php echo $text_items; ?></span> <i onclick="window.open('<?php echo $cart; ?>');"></i></a></button>
  <div class="content">
    ...
    <li class="mini-cart-info">
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td class="text-center text-danger"><button type="button" onclick="voucher.remove('<?php echo $voucher[version_compare(VERSION, '2.1', '<') ? 'key' : 'cart_id']; ?>');" title="<?php echo $button_remove; ?>" class="btn btn-danger btn-xs"><i class="fa fa-times"></i></button></td>
        </tr>
        <?php } ?>
      </table>
    </li>
