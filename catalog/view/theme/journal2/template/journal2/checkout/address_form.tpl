...
<?php /*  Wenliang removed, for Chinese naming conversion
            <div class="form-group required">
...
<?php /*  Wenliang removed, only one address needed
...
*/ ?>
            ...
            <div class="form-group required">
            <!-- huwen mod ,add display:none -->
                <label style="display: none" class="col-sm-2 control-label" for="input-<?php echo $type; ?>-country"><?php echo $entry_country; ?></label>
                <div class="col-sm-10">

                    <select  style="display: none"  name="<?php echo $type; ?>_country_id" id="input-<?php echo $type; ?>-country" class="form-control">
                    <!-- Huwen mod -->
