...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['repository'] = $this->url->link('catalog/repository', 'token='.$this->session->data['token'], 'SSL');
		...
		$data['report_coupon'] = $this->url->link('report/coupon', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['report_profit']=$this->url->link('report/profit', 'token=' . $this->session->data['token'], 'SSL');

		// Luke added for report (begin)
		$data['text_repository_report'] = $this->language->get('text_repository_report');
		$data['text_repo_topo'] = $this->language->get('text_repo_topo');
		$data['text_inventory'] = $this->language->get('text_inventory');
		$data['text_history'] = $this->language->get('text_history');
		$data['text_trans'] = $this->language->get('text_trans');

		$data['report_repo_topo'] = $this->url->link('repository/report/repo_topo', 'token='.$this->session->data['token'], 'SSL');
		$data['report_inventory'] = $this->url->link('repository/report/inventory', 'token='.$this->session->data['token'], 'SSL');
		$data['report_history']	= $this->url->link('repository/report/history', 'token='.$this->session->data['token'], 'SSL');
		$data['report_trans']	= $this->url->link('repository/report/trans', 'token='.$this->session->data['token'], 'SSL');

		$data['text_store_report'] = $this->language->get('text_store_report');
		$data['report_store_sale'] = $this->url->link('repository/report/store_sale', 'token='.$this->session->data['token'], 'SSL');
		$data['text_store_sale'] = $this->language->get('text_store_sale');
		$data['report_store_product_sale'] = $this->url->link('repository/report/store_product_sale', 'token='.$this->session->data['token'], 'SSL');
		$data['text_store_product_sale'] = $this->language->get('text_store_product_sale');

		$data['text_product_report'] = $this->language->get('text_product_report');
		$data['report_product'] = $this->url->link('report/product', 'token='.$this->session->data['token'], 'SSL');
		// Luke added for report (end)
