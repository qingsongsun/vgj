...
-->
      ...
      <li><a href="<?php echo $repository; ?>"><?php echo $text_repository; ?></a></li>
    </ul>
  </li>
<!--
  ...
  <li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i> <span><?php echo $text_reports; ?></span></a>
    <ul>
      <li><a class="parent"><?php echo $text_sale; ?></a>
        <ul>
          <li><a href="<?php echo $report_coupon; ?>"><?php echo $text_report_coupon; ?></a></li>
      ...
      <li><a class="parent"><?php echo $text_product; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $report_product; ?>"><?php echo $text_product_report; ?></a></li>
        </ul>
      </li>
      <li><a class="parent"><?php echo $text_customer; ?></a>
        <ul>
...
-->
      <li><a class="parent"><?php echo $text_repository_report; ?></a>
        <ul>
          <li><a href="<?php echo $report_repo_topo; ?>"><?php echo $text_repo_topo; ?></a></li>
          <li><a href="<?php echo $report_inventory; ?>"><?php echo $text_inventory; ?></a></li>
          <li><a href="<?php echo $report_history; ?>"><?php echo $text_history; ?></a></li>
          <li><a href="<?php echo $report_trans; ?>"><?php echo $text_trans; ?></a></li>
        </ul>
      </li>
      <li><a class="parent"><?php echo $text_store_report; ?></a>
        <ul>
          <li><a href="<?php echo $report_store_sale; ?>"><?php echo $text_store_sale; ?></a></li>
          <li><a href="<?php echo $report_store_product_sale; ?>"><?php echo $text_store_product_sale; ?></a></li>
                    <li><a href="<?php echo $report_profit; ?>"><?php echo '销售报表'; ?></a></li>
        </ul>
      </li>
    </ul>
