...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		$data['text_items'] = sprintf($this->language->get('text_items_without_price'), $this->cart->countProducts() + (isset($this->session->data['vouchers']) ? count($this->session->data['vouchers']) : 0));
